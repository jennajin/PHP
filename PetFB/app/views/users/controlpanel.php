...
<div class="row">
    <div class="col-md-6 mx-auto">
        <div class="card card-body bg-light mt-5">
            <form action="<?php echo URL_ROOT; ?>/users/controlpanel/<?php echo $_SESSION['user_id']; ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group margin-bottom-sm">
                        ...
                        <input type="email" name="email" id="email" class="form-control form-control-lg" value="<?php echo $data['email']; ?>" disabled>
                    </div>
                </div>
