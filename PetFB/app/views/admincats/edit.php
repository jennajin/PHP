...
<div class="row">
    <div class="card card-body bg-light mt-5 col-lg-10 col-lg-offset-2 mx-auto">
        <h2> Edit Cat</h2>
        <br>
        <form class="form-horizontal" action="<?php echo URL_ROOT; ?>/admincats/edit/<?php echo $data['catId']; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <div class="radio radio-info">
                        <input type="radio" name="marital" id="marital_0" class="with-gap" value="0" <?php if (!isset($data['marital']) || ($data['marital'])==0) echo "checked";?>>
                        <label for="marital_0">&nbsp;&nbsp;Single</label>
                    </div>

                    <div class="row">
                        <div class="radio radio-info col-md-5">
                            <input type="radio" name="marital" id="marital_1" class="with-gap" value="1" <?php if (($data['marital'])==1) echo "checked";?>>
                            <label for="marital_1">&nbsp;&nbsp;In relation with&nbsp;&nbsp;</label>
                        </div>
                        <div class="form-group col">
                            <select class="form-control form-control-lg" name="spouseId" id="spouseId"" <?php if (!isset($data['marital']) || ($data['marital'])==0 || !isset($data['spouseId'])) echo "disabled";?>>
                            <?php
                            echo "<option value='0'></option>";
